...
if __name__ == '__main__':
    ...
    online_data_dir = os.path.abspath(os.path.join('F:/MetaBCI-master/7.23更晚/测试1.0/MetaBCI/demos/brainflow_demos/ReceiverSystem'))
        ...
        while not quit_flag[0]:
            for idx in range(start_idx, end_idx):
                ...
                if os.path.exists(pkl_path) and idx not in already_processed:
                    ...
                    if isinstance(signal, np.ndarray) and signal.ndim == 2 and signal.shape[0] > 16 and signal.shape[1] >= 4500+500:
                        data = signal[16]
                        data = data[500:4500]
